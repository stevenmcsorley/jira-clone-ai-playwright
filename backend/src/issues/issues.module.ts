...
@Module({
  imports: [TypeOrmModule.forFeature([Issue, Comment, Attachment, Subtask, TimeLog, IssueLink, User]), EventsModule, WorkspacesModule, NotificationsModule, WebhooksModule],
