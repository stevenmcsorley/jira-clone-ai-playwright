...
let EstimationController = class EstimationController {
    constructor(estimationService, workspaceScope) {
        this.estimationService = estimationService;
        this.workspaceScope = workspaceScope;
    }
    async assertSession(sessionId, workspaceId) {
    ...
    async getSessionsByProject(projectId, req) {
        if (!projectId) {
    ...
    async getVoteStatistics(sessionId, issueId, req, round = 1) {
        await this.assertSession(sessionId, req.workspaceId);
