...
exports.IssuesModule = IssuesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([issue_entity_1.Issue, comment_entity_1.Comment, attachment_entity_1.Attachment, subtask_entity_1.Subtask, time_log_entity_1.TimeLog, issue_link_entity_1.IssueLink, user_entity_1.User]), events_module_1.EventsModule, workspaces_module_1.WorkspacesModule, notifications_module_1.NotificationsModule],
